  ...
  BFHColorPicker.prototype = {
    ...
    initPopover: function() {
      ...
      this.$element
        ...
        .on('mousedown.bfhcolorpicker.data-api touchstart.bfhcolorpicker.data-api', 'canvas', BFHColorPicker.prototype.mouseDown)
    ...
    mouseDown: function(e) {
      ...
      if (!isMobile()) {
        ...
        $(document)
          .on('touchend.bfhcolorpicker.data-api', {
            colorpicker: $parent
          }, BFHColorPicker.prototype.touchEnd);
  /*      $(document)
          .on('touchend.bfhcolorpicker.data-api', toggle, BFHColorPicker.prototype.toggle);*/
      }
    },
    ...
    touchEnd: function(e) {
      var coordX = e.originalEvent.changedTouches[0].pageX;
      var coordY = e.originalEvent.changedTouches[0].pageY;
      var $this = e.data.colorpicker;
      $this.data('bfhcolorpicker').updateVal(coordX, coordY);
      $(document).off('touchend.bfhcolorpicker.data-api');
      if ($this.data('bfhcolorpicker').options.close === true) {
        clearMenus();
      }
    },
